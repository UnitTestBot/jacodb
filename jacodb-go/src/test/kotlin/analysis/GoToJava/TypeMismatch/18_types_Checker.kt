...
class types_Checker {
	...
	var imports: List<analysis.GoToJava.TypeMismatch.types_PkgName>? = null
	var dotImportMap: Map<types_dotImportKey, analysis.GoToJava.TypeMismatch.types_PkgName>? = null
...
fun read_types_Checker(buffReader: BufferedReader, id: Int): types_Checker {
    ...
    res.imports = mapDec[readType]?.invoke(buffReader, id) as List<analysis.GoToJava.TypeMismatch.types_PkgName>?
    ...
    res.dotImportMap = mapDec[readType]?.invoke(buffReader, id) as Map<types_dotImportKey, analysis.GoToJava.TypeMismatch.types_PkgName>?
