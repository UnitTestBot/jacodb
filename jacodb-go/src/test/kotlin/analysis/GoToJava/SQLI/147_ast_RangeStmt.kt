...
fun read_ast_RangeStmt(buffReader: BufferedReader, id: Int): ast_RangeStmt {
	val res = ast_RangeStmt()
    if (id != -1) {
        if (ptrMap.containsKey(id)) {
            return ptrMap[id] as ast_RangeStmt
        }
        ptrMap[id] = res
    ...
    res.Range = mapDec[readType]?.invoke(buffReader, id) as Long?
