...
class ssa_opaqueType : ssaToJacoType {
...
fun read_ssa_opaqueType(buffReader: BufferedReader, id: Int): ssa_opaqueType {
	val res = ssa_opaqueType()
    if (id != -1) {
        if (ptrMap.containsKey(id)) {
            return ptrMap[id] as ssa_opaqueType
        }
        ptrMap[id] = res
