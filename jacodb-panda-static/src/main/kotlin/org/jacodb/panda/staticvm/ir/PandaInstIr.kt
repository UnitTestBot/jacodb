...
data class PandaBitcastInstIr(
    ...
    override fun <T> accept(visitor: PandaInstIrVisitor<T>): T =
        visitor.visitPandaBitcastInstIr(this)
}
...
@Serializable
@SerialName("LoadFromConstantPool")
data class PandaLoadFromConstantPoolInstIr(
    override val id: String,
    override val inputs: List<String> = emptyList(),
    override val users: List<String> = emptyList(),
    override val type: String,
    ...
    override fun <T> accept(visitor: PandaInstIrVisitor<T>): T =
        visitor.visitPandaLoadFromConstantPoolInstIr(this)
}

@Serializable
@SerialName("ResolveStatic")
data class PandaResolveStaticInstIr(
    override val id: String,
    override val inputs: List<String> = emptyList(),
    override val users: List<String> = emptyList(),
    override val type: String,
...
@Serializable
@SerialName("ResolveVirtual")
data class PandaResolveVirtualInstIr(
    override val id: String,
    override val inputs: List<String> = emptyList(),
    override val users: List<String> = emptyList(),
    override val type: String,
...
@Serializable
@SerialName("CallDynamic")
data class PandaCallDynamicInstIr(
    override val id: String,
    override val inputs: List<String> = emptyList(),
    override val users: List<String> = emptyList(),
    override val type: String,
    ...
    override fun <T> accept(visitor: PandaInstIrVisitor<T>): T =
        visitor.visitPandaCallDynamicInstIr(this)
}

@Serializable
@SerialName("CallResolvedVirtual")
data class PandaCallResolvedVirtualInstIr(
    override val id: String,
    override val inputs: List<String> = emptyList(),
    override val users: List<String> = emptyList(),
    override val type: String,
    ...
    override fun <T> accept(visitor: PandaInstIrVisitor<T>): T =
        visitor.visitPandaCallResolvedVirtualInstIr(this)
}

@Serializable
@SerialName("CallResolvedStatic")
data class PandaCallResolvedStaticInstIr(
    override val id: String,
    override val inputs: List<String> = emptyList(),
    override val users: List<String> = emptyList(),
    override val type: String,
    ...
    override fun <T> accept(visitor: PandaInstIrVisitor<T>): T =
        visitor.visitPandaCallResolvedStaticInstIr(this)
}

@Serializable
@SerialName("FillConstArray")
data class PandaFillConstArrayInstIr(
    override val id: String,
    override val inputs: List<String> = emptyList(),
    override val users: List<String> = emptyList(),
    override val type: String,
    ...
    override fun <T> accept(visitor: PandaInstIrVisitor<T>): T =
        visitor.visitPandaFillConstArrayInstIr(this)
}

@Serializable
@SerialName("Builtin")
data class PandaBuiltinInstIr(
    override val id: String,
    override val inputs: List<String> = emptyList(),
    override val users: List<String> = emptyList(),
    override val type: String,
    ...
    override fun <T> accept(visitor: PandaInstIrVisitor<T>): T =
        visitor.visitPandaBuiltinInstIr(this)
}

@Serializable
@SerialName("LoadResolvedObjectField")
data class PandaLoadResolvedObjectFieldInstIr(
    override val id: String,
    override val inputs: List<String> = emptyList(),
    override val users: List<String> = emptyList(),
    override val type: String,
    ...
    override fun <T> accept(visitor: PandaInstIrVisitor<T>): T =
        visitor.visitPandaLoadResolvedObjectFieldInstIr(this)
}

@Serializable
@SerialName("LoadResolvedObjectFieldStatic")
data class PandaLoadResolvedObjectFieldStaticInstIr(
    override val id: String,
    override val inputs: List<String> = emptyList(),
    override val users: List<String> = emptyList(),
    override val type: String,
    ...
    override fun <T> accept(visitor: PandaInstIrVisitor<T>): T =
        visitor.visitPandaLoadResolvedObjectFieldStaticInstIr(this)
}

@Serializable
@SerialName("StoreResolvedObjectField")
data class PandaStoreResolvedObjectFieldInstIr(
    override val id: String,
    override val inputs: List<String> = emptyList(),
    override val users: List<String> = emptyList(),
    override val type: String,
    ...
    override fun <T> accept(visitor: PandaInstIrVisitor<T>): T =
        visitor.visitPandaStoreResolvedObjectFieldInstIr(this)
}

@Serializable
@SerialName("StoreResolvedObjectFieldStatic")
data class PandaStoreResolvedObjectFieldStaticInstIr(
    override val id: String,
    override val inputs: List<String> = emptyList(),
    override val users: List<String> = emptyList(),
    override val type: String,
    ...
    override fun <T> accept(visitor: PandaInstIrVisitor<T>): T =
        visitor.visitPandaStoreResolvedObjectFieldStaticInstIr(this)
}

@Serializable
@SerialName("LoadObjectDynamic")
data class PandaLoadObjectDynamicInstIr(
    override val id: String,
    override val inputs: List<String> = emptyList(),
    override val users: List<String> = emptyList(),
    override val type: String,
    ...
    override fun <T> accept(visitor: PandaInstIrVisitor<T>): T =
        visitor.visitPandaLoadObjectDynamicInstIr(this)
}

@Serializable
@SerialName("StoreObjectDynamic")
data class PandaStoreObjectDynamicInstIr(
    override val id: String,
    override val inputs: List<String> = emptyList(),
    override val users: List<String> = emptyList(),
    override val type: String,
    ...
    override fun <T> accept(visitor: PandaInstIrVisitor<T>): T =
        visitor.visitPandaStoreObjectDynamicInstIr(this)
}

@Serializable
@SerialName("FunctionImmediate")
data class PandaFunctionImmediateInstIr(
    override val id: String,
    override val inputs: List<String> = emptyList(),
    override val users: List<String> = emptyList(),
    override val type: String,
    ...
    override fun <T> accept(visitor: PandaInstIrVisitor<T>): T =
        visitor.visitPandaFunctionImmediateInstIr(this)
}

@Serializable
@SerialName("HclassCheck")
data class PandaHclassCheckInstIr(
    override val id: String,
    override val inputs: List<String> = emptyList(),
    override val users: List<String> = emptyList(),
    override val type: String,
    ...
    override fun <T> accept(visitor: PandaInstIrVisitor<T>): T =
        visitor.visitPandaHclassCheckInstIr(this)
}

@Serializable
@SerialName("LoadObjFromConst")
data class PandaLoadObjFromConstInstIr(
    ...
    override fun <T> accept(visitor: PandaInstIrVisitor<T>): T =
        visitor.visitPandaLoadObjFromConstInstIr(this)
}

@Serializable
@SerialName("LoadImmediate")
data class PandaLoadImmediateInstIr(
    override val id: String,
    override val inputs: List<String> = emptyList(),
    override val users: List<String> = emptyList(),
    override val type: String,
    ...
    val constantPool: Long? = null,
    val string: String? = null,
    val offset: Long? = null,
) : PandaInstIr {
    override fun <T> accept(visitor: PandaInstIrVisitor<T>): T =
        visitor.visitPandaLoadImmediateInstIr(this)
}
