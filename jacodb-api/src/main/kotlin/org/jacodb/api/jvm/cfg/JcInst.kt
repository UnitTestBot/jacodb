...
interface JcInstLocation : CoreInstLocation<JcMethod> {
...
interface JcInst : CoreInst<JcInstLocation, JcExpr> {
    ...
    override fun <T> accept(visitor: InstVisitor<T>): T {
        require(visitor is JcInstVisitor<*>) { "TODO message" } // TODO this is wrong
        return accept(visitor as JcInstVisitor<T>)
    }
