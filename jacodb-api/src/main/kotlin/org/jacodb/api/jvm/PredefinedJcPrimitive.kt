...
object PredefinedJcPrimitives {
    ...
    @JvmStatic
    fun of(name: String, cp: JcProject, annotations: List<JcAnnotation> = listOf()): JcPrimitiveType? {
        if (valueSet.contains(name)) {
            return PredefinedJcPrimitive(cp, name, annotations)
        }
        return null
    }
 ...
 */
class PredefinedJcPrimitive(override val classpath: JcProject, override val typeName: String,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as PredefinedJcPrimitive
    ...
    override fun copyWithAnnotations(annotations: List<JcAnnotation>): JcType =
        PredefinedJcPrimitive(classpath, typeName, annotations)
}
