...
sealed class AbstractJcInstResult(val method: JcMethod) {
    ...
    class JcInstListResultImpl(method: JcMethod, override val instList: InstList<JcInst>) :
        AbstractJcInstResult(method), JcMethodExtFeature.JcInstListResult

    class JcRawInstListResultImpl(method: JcMethod, override val rawInstList: InstList<JcRawInst>) :
