...
class JcFieldImpl(
    ...
    override val declaration: JcDeclaration = JcDeclarationImpl.of(enclosingClass.declaration.location, this)
    ...
    override val annotations: List<JcAnnotation> by lazy(PUBLICATION) {
        info.annotations
