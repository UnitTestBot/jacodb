...
CREATE TABLE IF NOT EXISTS "Classes"(
                                        ...
                                        CONSTRAINT "fk_Classes_name__id" FOREIGN KEY ("name") REFERENCES "Symbols" ("id") ON DELETE RESTRICT ON UPDATE RESTRICT,
...
ALTER TABLE "Classes"
    ADD CONSTRAINT "fk_Classes_outer_method__id"
...
CREATE TABLE IF NOT EXISTS "Fields"(
    ...
    "class_id"    BIGINT NOT NULL,
    CONSTRAINT "fk_Fields_name__id" FOREIGN KEY ("name") REFERENCES "Symbols" ("id") ON DELETE RESTRICT ON UPDATE RESTRICT,
...
CREATE TABLE IF NOT EXISTS "Annotations"(
    ...
    "field_id"          BIGINT,
    "param_id"          BIGINT,
    CONSTRAINT "fk_Annotations_param_id__id" FOREIGN KEY ("param_id") REFERENCES "MethodParameters" ("id") ON DELETE RESTRICT ON UPDATE RESTRICT,
    CONSTRAINT "fk_Annotations_class_id__id" FOREIGN KEY ("class_id") REFERENCES "Classes" ("id") ON DELETE RESTRICT ON UPDATE RESTRICT,
    CONSTRAINT "fk_Annotations_field_id__id" FOREIGN KEY ("field_id") REFERENCES "Fields" ("id") ON DELETE RESTRICT ON UPDATE RESTRICT,
    CONSTRAINT "fk_Annotations_annotation_name__id" FOREIGN KEY ("annotation_name") REFERENCES "Symbols" ("id") ON DELETE RESTRICT ON UPDATE RESTRICT,
...
CREATE TABLE IF NOT EXISTS "AnnotationValues"(
    ...
    "class_symbol"      BIGINT,
    "enum_value"        BIGINT,
    CONSTRAINT "fk_AnnotationValues_annotation_id__id" FOREIGN KEY ("annotation_id") REFERENCES "Annotations" ("id") ON DELETE RESTRICT ON UPDATE RESTRICT,
    CONSTRAINT "fk_AnnotationValues_enum_value__id" FOREIGN KEY ("enum_value") REFERENCES "Symbols" ("id") ON DELETE RESTRICT ON UPDATE RESTRICT,
