...
open class AnnotationsRecord() : UpdatableRecordImpl<AnnotationsRecord>(org.jacodb.impl.storage.jooq.tables.Annotations.ANNOTATIONS), Record8<Long?, Long?, Boolean?, Long?, Long?, Long?, Long?, Long?> {
    ...
    override fun field1(): Field<Long?> = org.jacodb.impl.storage.jooq.tables.Annotations.ANNOTATIONS.ID
    override fun field2(): Field<Long?> = org.jacodb.impl.storage.jooq.tables.Annotations.ANNOTATIONS.ANNOTATION_NAME
    override fun field3(): Field<Boolean?> = org.jacodb.impl.storage.jooq.tables.Annotations.ANNOTATIONS.VISIBLE
    override fun field4(): Field<Long?> = org.jacodb.impl.storage.jooq.tables.Annotations.ANNOTATIONS.PARENT_ANNOTATION
    override fun field5(): Field<Long?> = org.jacodb.impl.storage.jooq.tables.Annotations.ANNOTATIONS.CLASS_ID
    override fun field6(): Field<Long?> = org.jacodb.impl.storage.jooq.tables.Annotations.ANNOTATIONS.METHOD_ID
    override fun field7(): Field<Long?> = org.jacodb.impl.storage.jooq.tables.Annotations.ANNOTATIONS.FIELD_ID
    override fun field8(): Field<Long?> = org.jacodb.impl.storage.jooq.tables.Annotations.ANNOTATIONS.PARAM_ID
