...
open class DefaultSchema : SchemaImpl("", org.jacodb.impl.storage.jooq.DefaultCatalog.Companion.DEFAULT_CATALOG) {
    companion object {

        /**
         * The reference instance of <code>DEFAULT_SCHEMA</code>
         */
        val DEFAULT_SCHEMA = org.jacodb.impl.storage.jooq.DefaultSchema()
    }

    /**
     * The table <code>Annotations</code>.
     */
    val ANNOTATIONS get() = org.jacodb.impl.storage.jooq.tables.Annotations.ANNOTATIONS
    ...
    override fun getCatalog(): Catalog = org.jacodb.impl.storage.jooq.DefaultCatalog.Companion.DEFAULT_CATALOG

    override fun getTables(): List<Table<*>> = listOf(
        org.jacodb.impl.storage.jooq.tables.Annotations.ANNOTATIONS,
