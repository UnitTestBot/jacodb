...
class OverridesTest : BaseTypesTest() {
    ...
    fun `types methods should respect overrides `() {
        val impl1 = cp.findClass<org.utbot.jacodb.impl.hierarchies.Overrides.Impl1>().toType()
        ...
        val impl2 = cp.findClass<org.utbot.jacodb.impl.hierarchies.Overrides.Impl2>().toType()
    ...
    fun `types fields should respect overrides and visibility`() {
        ...
        with(impl2.fields) {
            ...
            with(first { it.name == "main" }) {
                ...
                enclosingType.assertClassType<org.utbot.jacodb.impl.hierarchies.Overrides.Impl2>()
            }
            first { it.name == "publicMain" }.fieldType.assertClassType<String>()
            first { it.name == "protectedMain" }.fieldType.assertClassType<String>()
        }
    ...
    fun `class methods should respect overrides`() {
        val impl1 = cp.findClass<org.utbot.jacodb.impl.hierarchies.Overrides.Impl1>()
        assertEquals(1, impl1.constructors.size)
        ...
        val impl2 = cp.findClass<org.utbot.jacodb.impl.hierarchies.Overrides.Impl2>()
        assertEquals(1, impl2.constructors.size)
